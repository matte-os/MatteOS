...
namespace Kernel {
  ...
  SBIRet SBI::sbi_debug_console_write(unsigned long num_bytes, unsigned long base_addr_lo, unsigned long base_addr_hi) {
    return sbi_ecall(SBI_EXT_CONSOLE, 0, num_bytes, base_addr_lo, base_addr_hi, 0, 0, 0);
  }
  SBIRet SBI::sbi_debug_console_read(unsigned long num_bytes, unsigned long base_addr_lo, unsigned long base_addr_hi) {
